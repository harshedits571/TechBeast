      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 text-center md:p-12">
          ...
          <p className="text-slate-500 mb-8">
            Your order number is <span className="font-mono font-bold text-slate-800 bg-slate-100 px-2 py-1 rounded">{orderNumber}</span>
          </p>
          ...
          <div className="bg-slate-50 rounded-xl p-6 mb-8 text-left border border-slate-100">
            ...
            <p className="text-sm text-slate-600">
              ...
              If you chose Cash on Delivery, please have the exact amount ready when your package arrives.
            </p>
          </div>
